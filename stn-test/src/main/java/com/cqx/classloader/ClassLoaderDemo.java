...
public class ClassLoaderDemo {
    private static ClassLoader classLoader = LoadDemo.class.getClassLoader();
...
//            String path = classPath + File.separator + className.replace(".", File.separator);
            String path = "F:/projects/somethingnew/stn-test/target/classes/com/cqx/classloader/LoadDemo.class";
            try {
